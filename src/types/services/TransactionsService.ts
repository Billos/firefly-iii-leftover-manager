...
export class TransactionsService {
   ...
   * @throws ApiError
   */
  public static getTransactionByJournal(id: string, xTraceId?: string): CancelablePromise<TransactionSingle> {
    return __request(OpenAPI, {
      method: "GET",
   ...
   * @throws ApiError
   */
  public static deleteTransactionJournal(id: string, xTraceId?: string): CancelablePromise<void> {
    return __request(OpenAPI, {
      method: "DELETE",
      url: "/v1/transaction-journals/{id}",
      path: {
   ...
   * @throws ApiError
   */
  public static getTransaction(id: string, xTraceId?: string): CancelablePromise<TransactionSingle> {
    return __request(OpenAPI, {
      method: "GET",
   ...
   * @throws ApiError
   */
  public static deleteTransaction(id: string, xTraceId?: string): CancelablePromise<void> {
    return __request(OpenAPI, {
      method: "DELETE",
      url: "/v1/transactions/{id}",
      path: {
