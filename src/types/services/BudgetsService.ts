...
export class BudgetsService {
   ...
   * @throws ApiError
   */
  public static getBudgetLimit(id: string, limitId: number, xTraceId?: string): CancelablePromise<BudgetLimitSingle> {
    return __request(OpenAPI, {
      method: "GET",
   ...
   * @throws ApiError
   */
  public static deleteBudgetLimit(id: string, limitId: string, xTraceId?: string): CancelablePromise<void> {
    return __request(OpenAPI, {
      method: "DELETE",
      url: "/v1/budgets/{id}/limits/{limitId}",
      path: {
   ...
   * @throws ApiError
   */
  public static listBudgetLimit(start: string, end: string, xTraceId?: string): CancelablePromise<BudgetLimitArray> {
    return __request(OpenAPI, {
      method: "GET",
   ...
   * @throws ApiError
   */
  public static storeBudget(requestBody: BudgetStore, xTraceId?: string): CancelablePromise<BudgetSingle> {
    return __request(OpenAPI, {
      method: "POST",
      url: "/v1/budgets",
      headers: {
   ...
   * @throws ApiError
   */
  public static deleteBudget(id: string, xTraceId?: string): CancelablePromise<void> {
    return __request(OpenAPI, {
      method: "DELETE",
      url: "/v1/budgets/{id}",
      path: {
