...
export class AttachmentsService {
   ...
   * @throws ApiError
   */
  public static listAttachment(xTraceId?: string, limit?: number, page?: number): CancelablePromise<AttachmentArray> {
   ...
   * @throws ApiError
   */
  public static storeAttachment(requestBody: AttachmentStore, xTraceId?: string): CancelablePromise<AttachmentSingle> {
    return __request(OpenAPI, {
      method: "POST",
      url: "/v1/attachments",
      headers: {
   ...
   * @throws ApiError
   */
  public static getAttachment(id: string, xTraceId?: string): CancelablePromise<AttachmentSingle> {
    return __request(OpenAPI, {
      method: "GET",
   ...
   * @throws ApiError
   */
  public static deleteAttachment(id: string, xTraceId?: string): CancelablePromise<void> {
    return __request(OpenAPI, {
      method: "DELETE",
      url: "/v1/attachments/{id}",
      path: {
   ...
   * @throws ApiError
   */
  public static downloadAttachment(id: string, xTraceId?: string): CancelablePromise<Blob> {
    return __request(OpenAPI, {
      method: "GET",
   ...
   * @throws ApiError
   */
  public static uploadAttachment(id: string, xTraceId?: string, requestBody?: Blob): CancelablePromise<void> {
    return __request(OpenAPI, {
      method: "POST",
