...
export class RulesService {
   ...
   * @throws ApiError
   */
  public static listRule(xTraceId?: string, limit?: number, page?: number): CancelablePromise<RuleArray> {
    return __request(OpenAPI, {
      method: "GET",
      url: "/v1/rules",
      headers: {
   ...
   * @throws ApiError
   */
  public static storeRule(requestBody: RuleStore, xTraceId?: string): CancelablePromise<RuleSingle> {
    return __request(OpenAPI, {
      method: "POST",
      url: "/v1/rules",
      headers: {
   ...
   * @throws ApiError
   */
  public static getRule(id: string, xTraceId?: string): CancelablePromise<RuleSingle> {
    return __request(OpenAPI, {
      method: "GET",
      url: "/v1/rules/{id}",
      path: {
   ...
   * @throws ApiError
   */
  public static updateRule(id: string, requestBody: RuleUpdate, xTraceId?: string): CancelablePromise<RuleSingle> {
    return __request(OpenAPI, {
      method: "PUT",
      url: "/v1/rules/{id}",
      path: {
   ...
   * @throws ApiError
   */
  public static deleteRule(id: string, xTraceId?: string): CancelablePromise<void> {
    return __request(OpenAPI, {
      method: "DELETE",
      url: "/v1/rules/{id}",
      path: {
