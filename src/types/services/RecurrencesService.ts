...
export class RecurrencesService {
   ...
   * @throws ApiError
   */
  public static listRecurrence(xTraceId?: string, limit?: number, page?: number): CancelablePromise<RecurrenceArray> {
    return __request(OpenAPI, {
      method: "GET",
      url: "/v1/recurrences",
      headers: {
   ...
   * @throws ApiError
   */
  public static storeRecurrence(requestBody: RecurrenceStore, xTraceId?: string): CancelablePromise<RecurrenceSingle> {
    return __request(OpenAPI, {
      method: "POST",
      url: "/v1/recurrences",
      headers: {
   ...
   * @throws ApiError
   */
  public static getRecurrence(id: string, xTraceId?: string): CancelablePromise<RecurrenceSingle> {
    return __request(OpenAPI, {
      method: "GET",
   ...
   * @throws ApiError
   */
  public static deleteRecurrence(id: string, xTraceId?: string): CancelablePromise<void> {
    return __request(OpenAPI, {
      method: "DELETE",
      url: "/v1/recurrences/{id}",
      path: {
