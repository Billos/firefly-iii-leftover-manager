...
export class AccountsService {
   ...
   * @throws ApiError
   */
  public static storeAccount(requestBody: AccountStore, xTraceId?: string): CancelablePromise<AccountSingle> {
    return __request(OpenAPI, {
      method: "POST",
      url: "/v1/accounts",
      headers: {
   ...
   * @throws ApiError
   */
  public static getAccount(id: string, xTraceId?: string, date?: string): CancelablePromise<AccountSingle> {
    return __request(OpenAPI, {
      method: "GET",
      url: "/v1/accounts/{id}",
      path: {
   ...
   * @throws ApiError
   */
  public static deleteAccount(id: string, xTraceId?: string): CancelablePromise<void> {
    return __request(OpenAPI, {
      method: "DELETE",
      url: "/v1/accounts/{id}",
      path: {
