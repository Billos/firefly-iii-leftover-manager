...
export class WebhooksService {
   ...
   * @throws ApiError
   */
  public static getWebhookMessages(id: string, xTraceId?: string): CancelablePromise<WebhookMessageArray> {
   ...
   * @throws ApiError
   */
  public static deleteWebhookMessage(id: string, messageId: number, xTraceId?: string): CancelablePromise<void> {
    return __request(OpenAPI, {
      method: "DELETE",
      url: "/v1/webhooks/{id}/messages/{messageId}",
      path: {
   ...
   * @throws ApiError
   */
  public static submitWebook(id: string, xTraceId?: string): CancelablePromise<any> {
    return __request(OpenAPI, {
      method: "POST",
   ...
   * @throws ApiError
   */
  public static triggerTransactionWebhook(
    id: string,
   ...
   * @throws ApiError
   */
  public static listWebhook(xTraceId?: string, limit?: number, page?: number): CancelablePromise<WebhookArray> {
    return __request(OpenAPI, {
      method: "GET",
      url: "/v1/webhooks",
      headers: {
   ...
   * @throws ApiError
   */
  public static storeWebhook(requestBody: WebhookStore, xTraceId?: string): CancelablePromise<WebhookSingle> {
    return __request(OpenAPI, {
      method: "POST",
      url: "/v1/webhooks",
      headers: {
   ...
   * @throws ApiError
   */
  public static getWebhook(id: string, xTraceId?: string): CancelablePromise<WebhookSingle> {
    return __request(OpenAPI, {
      method: "GET",
      url: "/v1/webhooks/{id}",
      path: {
   ...
   * @throws ApiError
   */
  public static deleteWebhook(id: string, xTraceId?: string): CancelablePromise<void> {
    return __request(OpenAPI, {
      method: "DELETE",
      url: "/v1/webhooks/{id}",
      path: {
