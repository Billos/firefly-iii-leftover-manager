...
export class PreferencesService {
   ...
   * @throws ApiError
   */
  public static listPreference(xTraceId?: string, limit?: number, page?: number): CancelablePromise<PreferenceArray> {
   ...
   * @throws ApiError
   */
  public static storePreference(requestBody: Preference, xTraceId?: string): CancelablePromise<PreferenceSingle> {
    return __request(OpenAPI, {
      method: "POST",
      url: "/v1/preferences",
      headers: {
   ...
   * @throws ApiError
   */
  public static getPreference(name: string, xTraceId?: string): CancelablePromise<PreferenceSingle> {
    return __request(OpenAPI, {
      method: "GET",
