...
export class CurrenciesService {
   ...
   * @throws ApiError
   */
  public static listCurrency(xTraceId?: string, limit?: number, page?: number): CancelablePromise<CurrencyArray> {
    return __request(OpenAPI, {
      method: "GET",
      url: "/v1/currencies",
      headers: {
   ...
   * @throws ApiError
   */
  public static storeCurrency(requestBody: CurrencyStore, xTraceId?: string): CancelablePromise<CurrencySingle> {
    return __request(OpenAPI, {
      method: "POST",
      url: "/v1/currencies",
      headers: {
   ...
   * @throws ApiError
   */
  public static enableCurrency(code: string, xTraceId?: string): CancelablePromise<void> {
    return __request(OpenAPI, {
      method: "POST",
   ...
   * @throws ApiError
   */
  public static disableCurrency(code: string, xTraceId?: string): CancelablePromise<void> {
    return __request(OpenAPI, {
      method: "POST",
   ...
   * @throws ApiError
   */
  public static defaultCurrency(code: string, xTraceId?: string): CancelablePromise<void> {
    return __request(OpenAPI, {
      method: "POST",
   ...
   * @throws ApiError
   */
  public static getCurrency(code: string, xTraceId?: string): CancelablePromise<CurrencySingle> {
    return __request(OpenAPI, {
      method: "GET",
   ...
   * @throws ApiError
   */
  public static deleteCurrency(code: string, xTraceId?: string): CancelablePromise<void> {
    return __request(OpenAPI, {
      method: "DELETE",
      url: "/v1/currencies/{code}",
      path: {
   ...
   * @throws ApiError
   */
  public static getDefaultCurrency(xTraceId?: string): CancelablePromise<CurrencySingle> {
    return __request(OpenAPI, {
      method: "GET",
