...
export class ObjectGroupsService {
   ...
   * @throws ApiError
   */
  public static getObjectGroup(id: string, xTraceId?: string): CancelablePromise<ObjectGroupSingle> {
    return __request(OpenAPI, {
      method: "GET",
   ...
   * @throws ApiError
   */
  public static deleteObjectGroup(id: string, xTraceId?: string): CancelablePromise<void> {
    return __request(OpenAPI, {
      method: "DELETE",
      url: "/v1/object-groups/{id}",
      path: {
