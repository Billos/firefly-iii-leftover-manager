...
export class TagsService {
   ...
   * @throws ApiError
   */
  public static listTag(xTraceId?: string, limit?: number, page?: number): CancelablePromise<TagArray> {
    return __request(OpenAPI, {
      method: "GET",
      url: "/v1/tags",
      headers: {
   ...
   * @throws ApiError
   */
  public static storeTag(requestBody: TagModelStore, xTraceId?: string): CancelablePromise<TagSingle> {
    return __request(OpenAPI, {
      method: "POST",
      url: "/v1/tags",
      headers: {
   ...
   * @throws ApiError
   */
  public static getTag(tag: string, xTraceId?: string, limit?: number, page?: number): CancelablePromise<TagSingle> {
    return __request(OpenAPI, {
      method: "GET",
      url: "/v1/tags/{tag}",
      path: {
   ...
   * @throws ApiError
   */
  public static updateTag(tag: string, requestBody: TagModelUpdate, xTraceId?: string): CancelablePromise<TagSingle> {
    return __request(OpenAPI, {
      method: "PUT",
      url: "/v1/tags/{tag}",
      path: {
   ...
   * @throws ApiError
   */
  public static deleteTag(tag: string, xTraceId?: string): CancelablePromise<void> {
    return __request(OpenAPI, {
      method: "DELETE",
      url: "/v1/tags/{tag}",
      path: {
