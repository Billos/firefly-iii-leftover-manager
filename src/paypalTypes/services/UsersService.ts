...
export class UsersService {
   ...
   * @throws ApiError
   */
  public static listUser(xTraceId?: string, limit?: number, page?: number): CancelablePromise<UserArray> {
   ...
   * @throws ApiError
   */
  public static storeUser(requestBody: User, xTraceId?: string): CancelablePromise<UserSingle> {
    return __request(OpenAPI, {
      method: "POST",
      url: "/v1/users",
      headers: {
   ...
   * @throws ApiError
   */
  public static getUser(id: string, xTraceId?: string): CancelablePromise<UserSingle> {
    return __request(OpenAPI, {
      method: "GET",
      url: "/v1/users/{id}",
      path: {
   ...
   * @throws ApiError
   */
  public static updateUser(id: string, requestBody: User, xTraceId?: string): CancelablePromise<UserSingle> {
    return __request(OpenAPI, {
      method: "PUT",
      url: "/v1/users/{id}",
      path: {
   ...
   * @throws ApiError
   */
  public static deleteUser(id: string, xTraceId?: string): CancelablePromise<void> {
    return __request(OpenAPI, {
      method: "DELETE",
      url: "/v1/users/{id}",
      path: {
