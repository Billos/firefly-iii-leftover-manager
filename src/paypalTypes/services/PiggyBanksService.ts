...
export class PiggyBanksService {
   ...
   * @throws ApiError
   */
  public static listPiggyBank(xTraceId?: string, limit?: number, page?: number): CancelablePromise<PiggyBankArray> {
    return __request(OpenAPI, {
      method: "GET",
      url: "/v1/piggy-banks",
      headers: {
   ...
   * @throws ApiError
   */
  public static storePiggyBank(requestBody: PiggyBankStore, xTraceId?: string): CancelablePromise<PiggyBankSingle> {
    return __request(OpenAPI, {
      method: "POST",
      url: "/v1/piggy-banks",
      headers: {
   ...
   * @throws ApiError
   */
  public static getPiggyBank(id: string, xTraceId?: string): CancelablePromise<PiggyBankSingle> {
    return __request(OpenAPI, {
      method: "GET",
   ...
   * @throws ApiError
   */
  public static deletePiggyBank(id: string, xTraceId?: string): CancelablePromise<void> {
    return __request(OpenAPI, {
      method: "DELETE",
      url: "/v1/piggy-banks/{id}",
      path: {
