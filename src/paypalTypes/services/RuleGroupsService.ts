...
export class RuleGroupsService {
   ...
   * @throws ApiError
   */
  public static listRuleGroup(xTraceId?: string, limit?: number, page?: number): CancelablePromise<RuleGroupArray> {
    return __request(OpenAPI, {
      method: "GET",
      url: "/v1/rule-groups",
      headers: {
   ...
   * @throws ApiError
   */
  public static storeRuleGroup(requestBody: RuleGroupStore, xTraceId?: string): CancelablePromise<RuleGroupSingle> {
    return __request(OpenAPI, {
      method: "POST",
      url: "/v1/rule-groups",
      headers: {
   ...
   * @throws ApiError
   */
  public static getRuleGroup(id: string, xTraceId?: string): CancelablePromise<RuleGroupSingle> {
    return __request(OpenAPI, {
      method: "GET",
   ...
   * @throws ApiError
   */
  public static deleteRuleGroup(id: string, xTraceId?: string): CancelablePromise<void> {
    return __request(OpenAPI, {
      method: "DELETE",
      url: "/v1/rule-groups/{id}",
      path: {
