...
export class BillsService {
   ...
   * @throws ApiError
   */
  public static listRuleByBill(id: string, xTraceId?: string): CancelablePromise<RuleArray> {
    return __request(OpenAPI, {
      method: "GET",
   ...
   * @throws ApiError
   */
  public static storeBill(requestBody: BillStore, xTraceId?: string): CancelablePromise<BillSingle> {
    return __request(OpenAPI, {
      method: "POST",
      url: "/v1/bills",
      headers: {
   ...
   * @throws ApiError
   */
  public static getBill(id: string, xTraceId?: string, start?: string, end?: string): CancelablePromise<BillSingle> {
    return __request(OpenAPI, {
      method: "GET",
      url: "/v1/bills/{id}",
      path: {
   ...
   * @throws ApiError
   */
  public static updateBill(id: string, requestBody: BillUpdate, xTraceId?: string): CancelablePromise<BillSingle> {
    return __request(OpenAPI, {
      method: "PUT",
      url: "/v1/bills/{id}",
      path: {
   ...
   * @throws ApiError
   */
  public static deleteBill(id: string, xTraceId?: string): CancelablePromise<void> {
    return __request(OpenAPI, {
      method: "DELETE",
      url: "/v1/bills/{id}",
      path: {
