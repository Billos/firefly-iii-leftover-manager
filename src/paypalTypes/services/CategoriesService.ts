...
export class CategoriesService {
   ...
   * @throws ApiError
   */
  public static listCategory(xTraceId?: string, limit?: number, page?: number): CancelablePromise<CategoryArray> {
    return __request(OpenAPI, {
      method: "GET",
      url: "/v1/categories",
      headers: {
   ...
   * @throws ApiError
   */
  public static storeCategory(requestBody: Category, xTraceId?: string): CancelablePromise<CategorySingle> {
    return __request(OpenAPI, {
      method: "POST",
      url: "/v1/categories",
      headers: {
   ...
   * @throws ApiError
   */
  public static deleteCategory(id: string, xTraceId?: string): CancelablePromise<void> {
    return __request(OpenAPI, {
      method: "DELETE",
      url: "/v1/categories/{id}",
      path: {
