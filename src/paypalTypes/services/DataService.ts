...
export class DataService {
   ...
   * @throws ApiError
   */
  public static bulkUpdateTransactions(query: string): CancelablePromise<void> {
   ...
   * @throws ApiError
   */
  public static destroyData(objects: DataDestroyObject, xTraceId?: string): CancelablePromise<void> {
    return __request(OpenAPI, {
      method: "DELETE",
      url: "/v1/data/destroy",
      headers: {
   ...
   * @throws ApiError
   */
  public static exportAccounts(xTraceId?: string, type?: ExportFileFilter): CancelablePromise<Blob> {
    return __request(OpenAPI, {
      method: "GET",
   ...
   * @throws ApiError
   */
  public static exportBills(xTraceId?: string, type?: ExportFileFilter): CancelablePromise<Blob> {
    return __request(OpenAPI, {
      method: "GET",
   ...
   * @throws ApiError
   */
  public static exportBudgets(xTraceId?: string, type?: ExportFileFilter): CancelablePromise<Blob> {
    return __request(OpenAPI, {
      method: "GET",
   ...
   * @throws ApiError
   */
  public static exportCategories(xTraceId?: string, type?: ExportFileFilter): CancelablePromise<Blob> {
    return __request(OpenAPI, {
      method: "GET",
   ...
   * @throws ApiError
   */
  public static exportPiggies(xTraceId?: string, type?: ExportFileFilter): CancelablePromise<Blob> {
    return __request(OpenAPI, {
      method: "GET",
   ...
   * @throws ApiError
   */
  public static exportRecurring(xTraceId?: string, type?: ExportFileFilter): CancelablePromise<Blob> {
    return __request(OpenAPI, {
      method: "GET",
   ...
   * @throws ApiError
   */
  public static exportRules(xTraceId?: string, type?: ExportFileFilter): CancelablePromise<Blob> {
    return __request(OpenAPI, {
      method: "GET",
   ...
   * @throws ApiError
   */
  public static exportTags(xTraceId?: string, type?: ExportFileFilter): CancelablePromise<Blob> {
    return __request(OpenAPI, {
      method: "GET",
   ...
   * @throws ApiError
   */
  public static purgeData(xTraceId?: string): CancelablePromise<void> {
    return __request(OpenAPI, {
      method: "DELETE",
      url: "/v1/data/purge",
      headers: {
