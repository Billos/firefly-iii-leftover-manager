...
export class LinksService {
   ...
   * @throws ApiError
   */
  public static listLinkType(xTraceId?: string, limit?: number, page?: number): CancelablePromise<LinkTypeArray> {
    return __request(OpenAPI, {
      method: "GET",
      url: "/v1/link-types",
      headers: {
   ...
   * @throws ApiError
   */
  public static storeLinkType(requestBody: LinkType, xTraceId?: string): CancelablePromise<LinkTypeSingle> {
    return __request(OpenAPI, {
      method: "POST",
      url: "/v1/link-types",
      headers: {
   ...
   * @throws ApiError
   */
  public static getLinkType(id: string, xTraceId?: string): CancelablePromise<LinkTypeSingle> {
    return __request(OpenAPI, {
      method: "GET",
   ...
   * @throws ApiError
   */
  public static deleteLinkType(id: string, xTraceId?: string): CancelablePromise<void> {
    return __request(OpenAPI, {
      method: "DELETE",
      url: "/v1/link-types/{id}",
      path: {
   ...
   * @throws ApiError
   */
  public static getTransactionLink(id: string, xTraceId?: string): CancelablePromise<TransactionLinkSingle> {
    return __request(OpenAPI, {
      method: "GET",
   ...
   * @throws ApiError
   */
  public static deleteTransactionLink(id: string, xTraceId?: string): CancelablePromise<void> {
    return __request(OpenAPI, {
      method: "DELETE",
      url: "/v1/transaction-links/{id}",
      path: {
