...
class PreferencesService {
     ...
     * @throws ApiError
     */
    static listPreference(xTraceId, limit, page) {
     ...
     * @throws ApiError
     */
    static storePreference(requestBody, xTraceId) {
        return (0, request_1.request)(OpenAPI_1.OpenAPI, {
            method: 'POST',
            url: '/v1/preferences',
            headers: {
     ...
     * @throws ApiError
     */
    static getPreference(name, xTraceId) {
        return (0, request_1.request)(OpenAPI_1.OpenAPI, {
            method: 'GET',
     ...
     * @throws ApiError
     */
    static updatePreference(name, requestBody, xTraceId) {
        return (0, request_1.request)(OpenAPI_1.OpenAPI, {
            method: 'PUT',
            url: '/v1/preferences/{name}',
            path: {
