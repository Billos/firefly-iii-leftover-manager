...
class BillsService {
     ...
     * @throws ApiError
     */
    static listAttachmentByBill(id, xTraceId, limit, page) {
     ...
     * @throws ApiError
     */
    static listRuleByBill(id, xTraceId) {
        return (0, request_1.request)(OpenAPI_1.OpenAPI, {
            method: 'GET',
     ...
     * @throws ApiError
     */
    static listTransactionByBill(id, xTraceId, limit, page, start, end, type) {
        return (0, request_1.request)(OpenAPI_1.OpenAPI, {
            method: 'GET',
     ...
     * @throws ApiError
     */
    static listBill(xTraceId, limit, page, start, end) {
        return (0, request_1.request)(OpenAPI_1.OpenAPI, {
            method: 'GET',
            url: '/v1/bills',
            headers: {
     ...
     * @throws ApiError
     */
    static storeBill(requestBody, xTraceId) {
        return (0, request_1.request)(OpenAPI_1.OpenAPI, {
            method: 'POST',
            url: '/v1/bills',
            headers: {
     ...
     * @throws ApiError
     */
    static getBill(id, xTraceId, start, end) {
        return (0, request_1.request)(OpenAPI_1.OpenAPI, {
            method: 'GET',
            url: '/v1/bills/{id}',
            path: {
     ...
     * @throws ApiError
     */
    static updateBill(id, requestBody, xTraceId) {
        return (0, request_1.request)(OpenAPI_1.OpenAPI, {
            method: 'PUT',
            url: '/v1/bills/{id}',
            path: {
...
//# sourceMappingURL=BillsService.js.map