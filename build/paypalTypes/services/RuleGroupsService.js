...
class RuleGroupsService {
     ...
     * @throws ApiError
     */
    static listRuleByGroup(id, xTraceId, limit, page) {
     ...
     * @throws ApiError
     */
    static testRuleGroup(id, xTraceId, limit, page, start, end, searchLimit, triggeredLimit, accountsArray) {
        return (0, request_1.request)(OpenAPI_1.OpenAPI, {
            method: 'GET',
     ...
     * @throws ApiError
     */
    static fireRuleGroup(id, xTraceId, start, end, accountsArray) {
        return (0, request_1.request)(OpenAPI_1.OpenAPI, {
            method: 'POST',
     ...
     * @throws ApiError
     */
    static listRuleGroup(xTraceId, limit, page) {
        return (0, request_1.request)(OpenAPI_1.OpenAPI, {
            method: 'GET',
            url: '/v1/rule-groups',
            headers: {
     ...
     * @throws ApiError
     */
    static storeRuleGroup(requestBody, xTraceId) {
        return (0, request_1.request)(OpenAPI_1.OpenAPI, {
            method: 'POST',
            url: '/v1/rule-groups',
            headers: {
     ...
     * @throws ApiError
     */
    static getRuleGroup(id, xTraceId) {
        return (0, request_1.request)(OpenAPI_1.OpenAPI, {
            method: 'GET',
     ...
     * @throws ApiError
     */
    static updateRuleGroup(id, requestBody, xTraceId) {
        return (0, request_1.request)(OpenAPI_1.OpenAPI, {
            method: 'PUT',
            url: '/v1/rule-groups/{id}',
            path: {
     ...
     * @throws ApiError
     */
    static deleteRuleGroup(id, xTraceId) {
        return (0, request_1.request)(OpenAPI_1.OpenAPI, {
            method: 'DELETE',
            url: '/v1/rule-groups/{id}',
            path: {
...
//# sourceMappingURL=RuleGroupsService.js.map