...
exports.settingBudgetForTransaction = settingBudgetForTransaction;
...
async function settingBudgetForTransaction(req, res) {
    ...
    try {
        ...
        await transactionHandler_1.transactionHandler.deleteMessage("BudgetMessageId", messageId, transactionId);
    }
    catch (error) {
...
//# sourceMappingURL=settingBudgetForTransaction.js.map